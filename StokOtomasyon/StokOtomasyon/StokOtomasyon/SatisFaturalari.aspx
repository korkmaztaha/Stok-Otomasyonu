<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="SatisFaturalari.aspx.cs" Inherits="StokOtomasyon.SatisFatura" %>
                                    ...
                                    <asp:Repeater ID="rptTbl"  OnItemCommand="rptTbl_ItemCommand" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:LinkButton Text="Görüntüle" id="lnkSil" CommandArgument='<%#Eval("FaturaId")%>' CssClass="btn btn-primary" CommandName="edit" runat="server" /></td>
