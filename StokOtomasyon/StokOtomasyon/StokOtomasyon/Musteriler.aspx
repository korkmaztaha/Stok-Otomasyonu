<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Musteriler.aspx.cs" Inherits="StokOtomasyon.Musteriler" %>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-11">
                <div class="card">
                    ...
                    <div class="header">
                        <h4 class="title">Müşteri Bilgileri</h4>
                    </div>
                    <div class="content">
                        <div class="row">
                            <div class="col-md-3">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                            <h4 class="title">Müşteri Listesi</h4>
                        </div>
                        <asp:HiddenField ID="hdn_MusteriId" runat="server" />
                            ...
                            <asp:Repeater ID="rptTbl" OnItemCommand="rptTbl_ItemCommand" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:LinkButton Text="Görüntüle" CommandArgument='<%#Eval("FirmaId")%>' CssClass="btn btn-primary" CommandName="edit" runat="server" />
                                        </td>
                                        <td>
