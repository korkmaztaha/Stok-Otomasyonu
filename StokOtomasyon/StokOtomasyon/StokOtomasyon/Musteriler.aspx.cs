...
namespace StokOtomasyon
{
    public partial class Musteriler : System.Web.UI.Page
    {
        ...
        public void listele()
        {
            ...
            sql.CommandText = "sp_MusteriListele";
        ...
        protected void btn_Kayit_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@FirmaId", hdn_MusteriId.Value);
        ...
        {
            hdn_MusteriId.Value = e.CommandArgument.ToString();
            if (e.CommandName == "edit")
            {
                ...
                getir.Parameters.AddWithValue("@FirmaId", hdn_MusteriId.Value);
            ...
            else if (e.CommandName == "delete")
            {
                ...
                sil.Parameters.AddWithValue("@FirmaId", hdn_MusteriId.Value);
                sil.ExecuteNonQuery();
                listele();
            }
        }
